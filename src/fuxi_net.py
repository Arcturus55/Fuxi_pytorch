...
class FuXiNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.input_shape = [int(np.ceil(pressure_level_num / 2) + 1), h_size // 8, w_size // 8]
        ...
        self.swin_block = nn.ModuleList([BaseBlock(in_channels=out_channels,
    ...
    def forward(self, inputs):
        ...
        out_swin_block = torch.concat((out_skip, out_swin_block), axis=2)
